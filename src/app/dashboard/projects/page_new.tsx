...
import { FolderOpen, Plus, Eye, Edit, Trash2, Users, Search, Filter, TrendingUp, CheckCircle, Clock, XCircle, ArrowRight, Calendar, MapPin } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 via-indigo-700 to-blue-600 p-8 shadow-2xl">
        ...
        <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <Button
              onClick={() => alert('Create project functionality')}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border-2 border-yellow-100 hover:shadow-2xl transition-all cursor-pointer" onClick={() => setStatusFilter('concept')}>
        ...
        <Card className="border-2 border-green-100 hover:shadow-2xl transition-all cursor-pointer" onClick={() => setStatusFilter('active')}>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
        ...
        <Card className="border-2 border-blue-100 hover:shadow-2xl transition-all cursor-pointer" onClick={() => setStatusFilter('completed')}>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="flex gap-2 pt-4 border-t-2 border-gray-100">
                  ...
                  <Button
                    variant="primary"
                    size="sm"
                    onClick={() => alert(`Applications for project ${project.id}`)}
