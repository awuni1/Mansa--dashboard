      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-blue-700 to-blue-600 p-8 shadow-2xl">
        ...
        <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="space-y-2">
            ...
            <p className="text-blue-100 text-lg">Manage and track all platform projects</p>
          </div>
            ...
            <div className="flex-1 w-full lg:w-auto">
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-6 text-base border-2 border-gray-200 focus:border-blue-500 rounded-xl shadow-sm hover:shadow-md transition-all focus:outline-none"
                />
              </div>
            </div>
      ...
      {filteredProjects.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredProjects.map((project, index) => (
            <Card 
              key={project.id} 
              className="border-2 border-gray-100 hover:border-blue-300 hover:shadow-2xl transition-all duration-300 overflow-hidden group animate-slideInFromRight"
            >
              {/* Project Image/Banner */}
              <div className="relative h-48 bg-gradient-to-br from-blue-500 via-blue-500 to-blue-500 overflow-hidden">
                <div className="absolute inset-0 bg-grid-white/10"></div>
                <div className="absolute inset-0 flex items-center justify-center">
      ...
      {showViewModal && selectedProject && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setShowViewModal(false)} role="presentation">
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()} role="presentation">
            <div className="sticky top-0 bg-gradient-to-r from-blue-600 via-blue-600 to-blue-600 text-white px-8 py-6 flex items-center justify-between rounded-t-2xl z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm mt-1">Complete project information</p>
                </div>
              </div>
              <button
                type="button"
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-50 rounded-xl p-6 border-2 border-blue-100">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-blue-600 font-medium mt-1">Project ID: {selectedProject.id}</p>
                  </div>
            ...
            <div className="sticky top-0 bg-gradient-to-r from-blue-600 via-blue-600 to-blue-600 text-white px-8 py-6 flex items-center justify-between rounded-t-2xl z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm mt-1">Add a new project to the platform</p>
                </div>
              </div>
              <button
                type="button"
